...
class Ppfr {
	...
	public function getSubtipoDeProducto9()
	{
		return $this->subtipo_de_producto9;
	}

	public function setSubtipoDeProducto9($subtipo_de_producto9)
	{
		$this->subtipo_de_producto9 = $subtipo_de_producto9;
	}

	public function getAbreviatura9()
	{
		return $this->abreviatura9;
	}

	public function setAbreviatura9($abreviatura9)
	{
		$this->abreviatura9 = $abreviatura9;
	}
	...
	public function getValorMaximo9()
	{
		return $this->valor_maximo9;
	}

	public function setValorMaximo9($valor_maximo9)
	{
		$this->valor_maximo9 = $valor_maximo9;
	}

	public function getValorIndicador9()
	{
		return $this->valor_indicador9;
	}

	public function setValorIndicador9($valor_indicador9)
	{
		$this->valor_indicador9 = $valor_indicador9;
	}
	...
	function Ppfr($pIdPpfr = "", $pSubtipo_de_producto = "", $pAbreviatura = "",
		...
		$this -> grupo_de_investigacion = $pGrupo_de_investigacion;
		$this -> ppfrDAO = new PpfrDAO($this -> idPpfr, $this -> subtipo_de_producto, $this -> abreviatura,
			...
			$this -> subtipo_de_producto9, $this -> abreviatura9,
			...
			$this -> valor_maximo9, $this -> valor_indicador9,
	...
	function insert(){
		...
		$this -> connection -> run($this -> ppfrDAO -> insert2());
		$this -> connection -> run($this -> ppfrDAO -> insert3());
		$this -> connection -> run($this -> ppfrDAO -> insert4());
		$this -> connection -> run($this -> ppfrDAO -> insert5());
		$this -> connection -> run($this -> ppfrDAO -> insert6());
		$this -> connection -> run($this -> ppfrDAO -> insert7());
		$this -> connection -> run($this -> ppfrDAO -> insert8());
		$this -> connection -> run($this -> ppfrDAO -> insert9());
	...
	function consultarTotalRegistros($id){
		$this -> connection -> open();
		$this -> connection -> run($this -> ppfrDAO -> consultarTotalRegistros($id));
		$this -> connection -> close();
	...
	function consultarGraficaPpfr($id){
		$this -> connection -> open();
		$this -> connection -> run($this -> ppfrDAO -> consultarGraficaPpfr($id));
		$pcs = array();
		while ($result = $this -> connection -> fetchRow()){
			$grupo_de_investigacion = new Grupo_de_investigacion($result[5]);
			$grupo_de_investigacion -> select();
			array_push($pcs, new Ppfr($result[0], $result[1], $result[2],
				"", "","", "",
				"","","","",
				"", "", "", "",
				"", "", "", "",
