...
$monitoreo_ai = new Monitoreo_ai($idMonitoreo_ai);
$monitoreo_ai -> select();
?>
...
<div class="modal-header">
	<h4 class="modal-title">Monitoreo_ai</h4>
...
<div class="modal-body">
	<table class="table table-striped table-hover">
		<tr>
			<th>Variable</th>
			<td><?php echo $monitoreo_ai -> getVariable() ?></td>
		</tr>
		<tr>
			<th>Calificacion</th>
			<td><?php echo $monitoreo_ai -> getCalificacion() ?></td>
		</tr>
		<tr>
			<th>Grupo_de_investigacion</th>
			<td><?php echo $monitoreo_ai -> getGrupo_de_investigacion() -> getNombre() . " " . $monitoreo_ai -> getGrupo_de_investigacion() -> getApellido() . " " . $monitoreo_ai -> getGrupo_de_investigacion() -> getClasificacion() . " " . $monitoreo_ai -> getGrupo_de_investigacion() -> getLider() . " " . $monitoreo_ai -> getGrupo_de_investigacion() -> getArea() . " " . $monitoreo_ai -> getGrupo_de_investigacion() -> getPagina_web() ?></td>
		</tr>
	</table>
</div>
