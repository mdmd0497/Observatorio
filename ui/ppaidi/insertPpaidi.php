...
if(isset($_POST['insert'])){
	$newPpaidi = new Ppaidi("", $subtipo_de_producto, $abreviatura, $valor_maximo, $valor_indicador, $grupo_de_investigacion);
	$newPpaidi -> insert();
		...
		<div class="col-md-8">
			<div class="card">
				...
				<div class="card-body">
					...
					<?php } ?>
					<form id="form" method="post" action="index.php?pid=<?php echo base64_encode("ui/ppaidi/insertPpaidi.php") ?>" class="bootstrap-form needs-validation"   >
