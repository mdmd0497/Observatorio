...
if(isset($_POST['insert'])){
	$newPpnc = new Ppnc("", $subtipo_de_producto, $abreviatura, $valor_maximo, $valor_indicador, $grupo_de_investigacion);
	$newPpnc -> insert();
		...
		<div class="col-md-8">
			<div class="card">
				...
				<div class="card-body">
					...
					<?php } ?>
					<form id="form" method="post" action="index.php?pid=<?php echo base64_encode("ui/ppnc/insertPpnc.php") ?>" class="bootstrap-form needs-validation"   >
