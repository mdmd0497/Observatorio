...
<div class="container-fluid">
	<div class="card">
		<div class="card-header">
			<h4 class="card-title">Consultar Ppnc</h4>
		</div>
		<div class="card-body">
			...
			<table class="table table-striped table-hover">
				<thead>
					<tr><th></th>
						...
						<?php } else { ?>
							<a href='index.php?pid=<?php echo base64_encode("ui/ppnc/selectAllPpnc.php") ?>&order=subtipo_de_producto&dir=asc'>
						...
						<?php } else { ?>
							<a href='index.php?pid=<?php echo base64_encode("ui/ppnc/selectAllPpnc.php") ?>&order=subtipo_de_producto&dir=desc'>
						...
						<?php if($order=="abreviatura" && $dir=="asc") { ?>
							<span class='fas fa-sort-up'></span>
						<?php } else { ?>
							<a href='index.php?pid=<?php echo base64_encode("ui/ppnc/selectAllPpnc.php") ?>&order=abreviatura&dir=asc'>
							<span class='fas fa-sort-amount-up' data-toggle='tooltip' class='tooltipLink' data-original-title='Ordenar Ascendente' ></span></a>
						<?php } ?>
						<?php if($order=="abreviatura" && $dir=="desc") { ?>
							<span class='fas fa-sort-down'></span>
						<?php } else { ?>
							<a href='index.php?pid=<?php echo base64_encode("ui/ppnc/selectAllPpnc.php") ?>&order=abreviatura&dir=desc'>
							<span class='fas fa-sort-amount-down' data-toggle='tooltip' class='tooltipLink' data-original-title='Ordenar Descendente' ></span></a>
						<?php } ?>
						</th>
						...
						<?php if($order=="valor_maximo" && $dir=="asc") { ?>
							<span class='fas fa-sort-up'></span>
						<?php } else { ?>
							<a href='index.php?pid=<?php echo base64_encode("ui/ppnc/selectAllPpnc.php") ?>&order=valor_maximo&dir=asc'>
							<span class='fas fa-sort-amount-up' data-toggle='tooltip' class='tooltipLink' data-original-title='Ordenar Ascendente' ></span></a>
						<?php } ?>
						<?php if($order=="valor_maximo" && $dir=="desc") { ?>
							<span class='fas fa-sort-down'></span>
						<?php } else { ?>
							<a href='index.php?pid=<?php echo base64_encode("ui/ppnc/selectAllPpnc.php") ?>&order=valor_maximo&dir=desc'>
							<span class='fas fa-sort-amount-down' data-toggle='tooltip' class='tooltipLink' data-original-title='Ordenar Descendente' ></span></a>
						<?php } ?>
						</th>
						...
						<?php if($order=="valor_indicador" && $dir=="asc") { ?>
							<span class='fas fa-sort-up'></span>
						<?php } else { ?>
							<a href='index.php?pid=<?php echo base64_encode("ui/ppnc/selectAllPpnc.php") ?>&order=valor_indicador&dir=asc'>
							<span class='fas fa-sort-amount-up' data-toggle='tooltip' class='tooltipLink' data-original-title='Ordenar Ascendente' ></span></a>
						<?php } ?>
						<?php if($order=="valor_indicador" && $dir=="desc") { ?>
							<span class='fas fa-sort-down'></span>
						<?php } else { ?>
							<a href='index.php?pid=<?php echo base64_encode("ui/ppnc/selectAllPpnc.php") ?>&order=valor_indicador&dir=desc'>
							<span class='fas fa-sort-amount-down' data-toggle='tooltip' class='tooltipLink' data-original-title='Ordenar Descendente' ></span></a>
						<?php } ?>
						</th>
					...
					$ppnc = new Ppnc();
					if($order != "" && $dir != "") {
						$ppncs = $ppnc -> selectAllOrder($order, $dir);
					} else {
						$ppncs = $ppnc -> selectAll();
					}
					$counter = 1;
					foreach ($ppncs as $currentPpnc) {
						...
						if($_SESSION['entity'] == 'Administrador') {
							echo "<a href='index.php?pid=" . base64_encode("ui/ppnc/selectAllPpnc.php") . "&idPpnc=" . $currentPpnc -> getIdPpnc() . "&action=delete' onclick='return confirm(\"Confirma eliminar Ppnc: " . $currentPpnc -> getSubtipo_de_producto() . " " . $currentPpnc -> getAbreviatura() . " " . $currentPpnc -> getValor_maximo() . " " . $currentPpnc -> getValor_indicador() . "\")'><span class='fas fa-backspace' data-toggle='tooltip' data-placement='left' class='tooltipLink' data-original-title='Delete Ppnc' ></span></a> ";
						}
						echo "</td>";
						echo "</tr>";
						$counter++;
