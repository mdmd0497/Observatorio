...
if(!empty($_GET['action']) && $_GET['action']=="delete"){
	...
	if($deleteEmpresas_centros_investigacion -> delete()){
		$nameGrupo_de_investigacion = $deleteEmpresas_centros_investigacion -> getGrupo_de_investigacion() -> getNombre() . " " . $deleteEmpresas_centros_investigacion -> getGrupo_de_investigacion() -> getApellido() . " " . $deleteEmpresas_centros_investigacion -> getGrupo_de_investigacion() -> getClasificacion() . " " . $deleteEmpresas_centros_investigacion -> getGrupo_de_investigacion() -> getLider() . " " . $deleteEmpresas_centros_investigacion -> getGrupo_de_investigacion() -> getArea() . " " . $deleteEmpresas_centros_investigacion -> getGrupo_de_investigacion() -> getPagina_web();
...
<div class="container-fluid">
	<div class="card">
		<div class="card-header">
			<h4 class="card-title">Consultar Empresas_centros_investigacion de Grupo_de_investigacion: <em><?php echo $grupo_de_investigacion -> getNombre() . " " . $grupo_de_investigacion -> getApellido() . " " . $grupo_de_investigacion -> getClasificacion() . " " . $grupo_de_investigacion -> getLider() . " " . $grupo_de_investigacion -> getArea() . " " . $grupo_de_investigacion -> getPagina_web() ?></em></h4>
		</div>
		<div class="card-body">
			...
			<table class="table table-striped table-hover">
				<thead>
					<tr><th></th>
						...
						<?php } else { ?>
							<a data-toggle='tooltip' class='tooltipLink' data-original-title='Ordenar Ascendente' href='index.php?pid=<?php echo base64_encode("ui/empresas_centros_investigacion/selectAllEmpresas_centros_investigacionByGrupo_de_investigacion.php") ?>&idGrupo_de_investigacion=<?php echo $_GET['idGrupo_de_investigacion'] ?>&order=variable&dir=asc'>
							<span class='fas fa-sort-amount-up'></span></a>
						<?php } ?>
						<?php if($order=="variable" && $dir=="desc") { ?>
							<span class='fas fa-sort-down'></span>
						<?php } else { ?>
							<a data-toggle='tooltip' class='tooltipLink' data-original-title='Ordenar Descendente' href='index.php?pid=<?php echo base64_encode("ui/empresas_centros_investigacion/selectAllEmpresas_centros_investigacionByGrupo_de_investigacion.php") ?>&idGrupo_de_investigacion=<?php echo $_GET['idGrupo_de_investigacion'] ?>&order=variable&dir=desc'>
					...
					<?php
					$empresas_centros_investigacion = new Empresas_centros_investigacion("", "", "", $_GET['idGrupo_de_investigacion']);
					if($order!="" && $dir!="") {
						$empresas_centros_investigacions = $empresas_centros_investigacion -> selectAllByGrupo_de_investigacionOrder($order, $dir);
					} else {
						$empresas_centros_investigacions = $empresas_centros_investigacion -> selectAllByGrupo_de_investigacion();
					}
					$counter = 1;
					foreach ($empresas_centros_investigacions as $currentEmpresas_centros_investigacion) {
						...
						if($_SESSION['entity'] == 'Administrador') {
							echo "<a href='index.php?pid=" . base64_encode("ui/empresas_centros_investigacion/selectAllEmpresas_centros_investigacionByGrupo_de_investigacion.php") . "&idGrupo_de_investigacion=" . $_GET['idGrupo_de_investigacion'] . "&idEmpresas_centros_investigacion=" . $currentEmpresas_centros_investigacion -> getIdEmpresas_centros_investigacion() . "&action=delete' onclick='return confirm(\"Confirm to delete Empresas_centros_investigacion: " . $currentEmpresas_centros_investigacion -> getVariable() . " " . $currentEmpresas_centros_investigacion -> getCalificacion() . "\")'> <span class='fas fa-backspace' data-toggle='tooltip' data-placement='left' class='tooltipLink' data-original-title='Delete Empresas_centros_investigacion' ></span></a> ";
						}
						echo "</td>";
						echo "</tr>";
						$counter++;
