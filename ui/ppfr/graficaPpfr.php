...
if (isset($_POST['generar'])) {
    $ppfr = new Ppfr();
    $registros = $ppfr->consultarGraficaPpfr($grupo_de_investigacion);
        ...
        <div class="col-md-8 min-vh-100">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Gr&aacute;fica Perfil de productos resultado de actividades relacionadas con la Formación del Recurso Humano en CTI</h4>
                </div>
                <div class="card-body">
                    <form id="form" method="post" action="index.php?pid=<?php echo base64_encode("ui/ppfr/graficaPpfr.php") ?>" class="bootstrap-form needs-validation"   >
                    ...
                    <?php if($processed){
                        ...
                        <script type="text/javascript">
                            ...
                            function drawChart() {
                                ...
                                var options = {
                                    title : "Perfil de productos resultado de actividades relacionadas con la Formación del Recurso Humano en CTI",
                                    pieHole: 0.4,
                        ...
                        <div class="text-center" id="barchartPpnc" style="width: 700px; height: 1000px;"></div>
                    <?php } ?>
                </div>
            </div>
        </div>
