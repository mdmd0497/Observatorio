...
if(isset($_POST['insert'])){
	$newPpfr = new Ppfr("", $subtipo_de_producto, $abreviatura, $valor_maximo, $valor_indicador, $grupo_de_investigacion);
	$newPpfr -> insert();
		...
		<div class="col-md-8">
			<div class="card">
				...
				<div class="card-body">
					...
					<?php } ?>
					<form id="form" method="post" action="index.php?pid=<?php echo base64_encode("ui/ppfr/insertPpfr.php") ?>" class="bootstrap-form needs-validation"   >
