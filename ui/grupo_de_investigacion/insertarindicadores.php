...
if(isset($_POST['insert'])){
    $newPc = new Pc("", $indicador, $abreviatura, $valor_maximo, $valor_indicador, $grupo_de_investigacion);
    $newPc -> insert();
		...
		<div class="col-md-8">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title">Crear Perfil de colaboración</h4>
				</div>
				<div class="card-body">
					<?php if($processed){ ?>
					...
					<?php } ?>
					<form id="form" method="post" action="index.php?pid=<?php echo base64_encode("ui/pc/insertPc.php") ?>" class="bootstrap-form needs-validation"   >
						<div class="form-group">
							<label>Indicador</label>
                            <input type="text" class="form-control" name="abreviatura" id="abreviatura" value="<?php echo "Indicador de cohesion" ?> "disabled>
						</div>
						<div class="form-group">
							<label>Abreviatura</label>
							<input type="text" class="form-control" name="abreviatura" id="abreviatura" value="<?php echo "IC" ?>"disabled >
						</div>
						<div class="form-group">
							<label>Valor_maximo</label>
							<input type="text" class="form-control" name="valor_maximo" value="<?php echo $valor_maximo ?>"/>
						</div>
						<div class="form-group">
							<label>Valor_indicador</label>
							<input type="text" class="form-control" name="valor_indicador" value="<?php echo $valor_indicador ?>"/>
						</div>
