...
<div class="container-fluid">
	<div class="card">
		<div class="card-header">
			<h4 class="card-title">Consultar Explotacion_base_tecnologica de Grupo_de_investigacion: <em><?php echo $grupo_de_investigacion -> getNombre() . " " . $grupo_de_investigacion -> getApellido() . " " . $grupo_de_investigacion -> getClasificacion() . " " . $grupo_de_investigacion -> getLider() . " " . $grupo_de_investigacion -> getArea() . " " . $grupo_de_investigacion -> getPagina_web() ?></em></h4>
		</div>
		<div class="card-body">
		<?php if(isset($_GET['action']) && $_GET['action']=="delete"){ ?>
			...
			<table class="table table-striped table-hover">
				<thead>
					...
					<?php
					$explotacion_base_tecnologica = new Explotacion_base_tecnologica("", "", "", $_GET['idGrupo_de_investigacion']);
					if($order!="" && $dir!="") {
						$explotacion_base_tecnologicas = $explotacion_base_tecnologica -> selectAllByGrupo_de_investigacionOrder($order, $dir);
					} else {
						$explotacion_base_tecnologicas = $explotacion_base_tecnologica -> selectAllByGrupo_de_investigacion();
					}
					$counter = 1;
					foreach ($explotacion_base_tecnologicas as $currentExplotacion_base_tecnologica) {
						...
						if($_SESSION['entity'] == 'Administrador') {
							echo "<a href='index.php?pid=" . base64_encode("ui/explotacion_base_tecnologica/selectAllExplotacion_base_tecnologicaByGrupo_de_investigacion.php") . "&idGrupo_de_investigacion=" . $_GET['idGrupo_de_investigacion'] . "&idExplotacion_base_tecnologica=" . $currentExplotacion_base_tecnologica -> getIdExplotacion_base_tecnologica() . "&action=delete' onclick='return confirm(\"Confirm to delete Explotacion_base_tecnologica: " . $currentExplotacion_base_tecnologica -> getVariable() . " " . $currentExplotacion_base_tecnologica -> getCalificacion() . "\")'> <span class='fas fa-backspace' data-toggle='tooltip' data-placement='left' class='tooltipLink' data-original-title='Delete Explotacion_base_tecnologica' ></span></a> ";
						}
						echo "</td>";
						echo "</tr>";
						$counter++;
