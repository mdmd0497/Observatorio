...
if(isset($_POST['update'])){
	if($_POST['newPassword'] == $_POST['newPasswordConfirm']){
		...
		if($updateUsuario_ud -> getClave() == md5($_POST['currentPassword'])){
			$updateUsuario_ud -> updateClave($_POST['newPassword']);
			...
			$logUsuario_ud = new LogUsuario_ud("","Editar Clave Usuario_ud", "", date("Y-m-d"), date("H:i:s"), $user_ip, PHP_OS, $browser, $_SESSION['id']);
		...
		<div class="col-md-8">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title">Editar Clave Usuario_ud</h4>
				</div>
				<div class="card-body">
					<?php if($processed){ ?>
					...
					<?php } ?>
					<form id="form" method="post" action="index.php?pid=<?php echo base64_encode("ui/usuario_ud/updatePasswordUsuario_ud.php") ?>" class="bootstrap-form needs-validation"   >
