...
$updateCultura_investigativa = new Cultura_investigativa($idCultura_investigativa);
...
if(isset($_POST['update'])){
	$updateCultura_investigativa = new Cultura_investigativa($idCultura_investigativa, $variable, $calificacion, $grupo_de_investigacion);
	$updateCultura_investigativa -> update();
	$updateCultura_investigativa -> select();
	...
	if($_SESSION['entity'] == 'Administrador'){
		$logAdministrador = new LogAdministrador("","Editar Cultura_investigativa", "Variable: " . $variable . "; Calificacion: " . $calificacion . "; Grupo_de_investigacion: " . $nameGrupo_de_investigacion , date("Y-m-d"), date("H:i:s"), $user_ip, PHP_OS, $browser, $_SESSION['id']);
		$logAdministrador -> insert();
	}
	else if($_SESSION['entity'] == 'Usuario_ud'){
		$logUsuario_ud = new LogUsuario_ud("","Editar Cultura_investigativa", "Variable: " . $variable . "; Calificacion: " . $calificacion . "; Grupo_de_investigacion: " . $nameGrupo_de_investigacion , date("Y-m-d"), date("H:i:s"), $user_ip, PHP_OS, $browser, $_SESSION['id']);
		$logUsuario_ud -> insert();
	}
	else if($_SESSION['entity'] == 'Grupo_de_investigacion'){
		$logGrupo_de_investigacion = new LogGrupo_de_investigacion("","Editar Cultura_investigativa", "Variable: " . $variable . "; Calificacion: " . $calificacion . "; Grupo_de_investigacion: " . $nameGrupo_de_investigacion , date("Y-m-d"), date("H:i:s"), $user_ip, PHP_OS, $browser, $_SESSION['id']);
		...
		<div class="col-md-8">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title">Editar Cultura_investigativa</h4>
				</div>
				<div class="card-body">
					<?php if($processed){ ?>
					...
					<form id="form" method="post" action="index.php?pid=<?php echo base64_encode("ui/cultura_investigativa/updateCultura_investigativa.php") . "&idCultura_investigativa=" . $idCultura_investigativa ?>" class="bootstrap-form needs-validation"  >
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" name="calificacion" value="<?php echo $updateCultura_investigativa -> getCalificacion() ?>"/>
						</div>
					<div class="form-group">
